...
/** @export */ Blockly.Msg.CONTROLS_FOREACH_TITLE = "遍历列表 %2 中的所有项目 %1";
...
/** @export */ Blockly.Msg.CONTROLS_FOR_TITLE = "从 %2 到 %3 每隔 %4 遍历 %1";
...
/** @export */ Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "循环，当不满足";
/** @export */ Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "循环，当满足";
...
/** @export */ Blockly.Msg.LISTS_CREATE_EMPTY_TITLE = "生成空列表";
...
/** @export */ Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "生成列表，内容为：";
/** @export */ Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP = "将一个项添加到列表中。";
/** @export */ Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP = "建立一个具有任意数量项目的列表。";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_FIRST = "第一个";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_FROM_END = "倒数第";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_FROM_START = "正数第";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_GET = "获取";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_GET_REMOVE = "获取并删除";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_LAST = "最后一个";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_RANDOM = "任意(随机)";
/** @export */ Blockly.Msg.LISTS_GET_INDEX_REMOVE = "删除";
...
/** @export */ Blockly.Msg.LISTS_INDEX_OF_FIRST = "找出第一个";
...
/** @export */ Blockly.Msg.LISTS_INDEX_OF_LAST = "找出最后一个";
...
/** @export */ Blockly.Msg.LISTS_REPEAT_TITLE = "生成有 %2 个 %1 的列表";
...
/** @export */ Blockly.Msg.PROCEDURES_DEFNORETURN_DO = "空值";
/** @export */ Blockly.Msg.PROCEDURES_DEFNORETURN_HELPURL = "https://zh.wikipedia.org/wiki/子程序";
/** @export */ Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = "待命名函数";
/** @export */ Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = "定义函数";
